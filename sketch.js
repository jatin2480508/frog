...
// CREATING ALL THE SPRITES FOR POND AND FROGS
function setup() {
...
//INCREASES THE SCORE WHEN U HOLD THE FROG
...
//VELOCITY OF ALL THE FROGS
  ...
  //THIS IS HUMPING UP AND DOWN EFFECT THAT FROG IS GOING UNDER THE WATER
  if(frog1.y<250){
    flag=1;
  }
  if(frog2.y<250){
...
//THIS IS ALL THE JUMPING EFFECT OF THE FROG
if(flag===1){
  frog1.velocityY=15;
}
if(flag===2){
...
//THIS IS FOR HOLDING AND DRAGGING THE MOUSE
